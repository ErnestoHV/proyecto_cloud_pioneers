...
<div id="nav-bar">
  ...
  <div id="nav-header">
    <a id="nav-title" href= "https://www.inaoep.mx/~liee/" target="_blank"><i class="fab fa-codepen"></i>LIEE</a>
    <label for="nav-toggle"><span id="nav-toggle-burger"></span></label>
    <hr/>
  </div>
  <div id="nav-content">
    <div class="nav-button"><i class="fas fa-palette"></i><span>Principal</span></div>
    <div class="nav-button"><i class="fas fa-images"></i><span>CRUD</span></div>`
